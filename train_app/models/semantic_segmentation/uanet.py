...
class Uncertainty_Aware_Fusion_Module(nn.Module):
    def __init__(self,high_channel,low_channel,out_channel,num_classes, ura_ranks=[1, 2, 3, 4, 5]):
        super(Uncertainty_Aware_Fusion_Module, self).__init__()
        self.rank = Uncertainty_Rank_Algorithm(ura_ranks)
...
@model_registry.register("UANet_VGG")
class UANet_VGG(SemanticSegmentationAdapter):
    def __init__(self, channel, num_classes, ura_ranks=[1, 2, 3, 4, 5],*args, **kwargs):
        super(UANet_VGG, self).__init__(*args, **kwargs)
